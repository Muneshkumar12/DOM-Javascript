...
var placeholderimg = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvKjDJtuPfRRSvZTLgDL4_HZue4AJCnLJl7XuR_bAuarccc8o2wQ1EljtkNc6oxRu7PbU&usqp=CAU";
...
for(i = 0; i<profilelist.length; i++){
    ...
    card.setAttribute("class" , "card col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12");
    if(profilelist[i] === ""){
